/**
 * Breaks responses into 2000 char length (max discord allows)
...
function breakUpResponse(response, splitChar = "!@#", wrapChar = "```") {
  ...
  // Merge strings back together into chunks that do not exceed MAX_NO_WRAP_LENGTH
  let strBuild = "";
  let responseArray = [];
...
module.exports = { breakUpResponse };
