...
export function playsServiceFactory(db: KevbotDb, tracksService: TracksService, playlistsService: PlaylistsService) {
  ...
  return {
    logTracksPlay,
    logRandomPlaylistPlay,
  };
}

export type PlaysService = ReturnType<typeof playsServiceFactory>;
