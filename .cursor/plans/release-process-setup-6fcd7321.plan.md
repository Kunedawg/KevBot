<!-- 6fcd7321-7a38-40e0-9665-c27cc65ffc11 f62981f1-32cb-4a77-8013-745bdccb2bea -->
...
**The Problem**: With squash merge, individual commits in PRs get discarded - only the PR title becomes the final commit!

**What needs conventional format**:
...
**Component CHANGELOGs** (auto-generated by release-please):
...
Replace `CONTRIBUTING.md` with comprehensive workflow:
...
**Valid scopes**: project, api, frontend, db, gcloud, tools, bot
...
- **Low cognitive overhead**: Only think about format when writing PR title
- **Review control**: You merge release PRs manually when ready

### To-dos

- [ ] Configure GitHub branch protection and squash-merge-only settings
- [ ] Create release-please workflow and configuration files for monorepo
- [ ] Add VERSION.txt files for tools and gcloud components
- [ ] Rewrite CONTRIBUTING.md with complete workflow, commit examples, and release process
- [ ] Bootstrap component CHANGELOGs with current versions if needed
- [ ] Update deployment workflows to support tag-based releases
- [ ] Clean up RELEASE_NOTES.md and CONTRIBUTING_OLD.md, update README.md
- [ ] Add commit message template and VS Code recommendations (optional)